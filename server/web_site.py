import configparser
from web_server import app, app_vars
from web_data import WebData
from web_code import WebAuth, WebIndex, WebDevice, WebDevices, WebEvents, WebNotify, WebReports, WebSettings, WebSearch, WebUsers, WebViews
...
def load_config():
    try:
        ...
        WebData.db = database['name']
        WebData.user = database['user']
        WebData.password = database['password']
    except: pass
